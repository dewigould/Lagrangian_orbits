...
j=1.1*initial_x_asteroidref
initial_x_asteroid2=j
initial_y_asteroid2=0

initial_conditions_asteroid2=[initial_x_asteroid2, initial_vx_asteroidref, initial_y_asteroid2, initial_vy_asteroidref]
solnasteroid2=spi.odeint(asteroid,initial_conditions_asteroid2,t2,args=(x_planet_old,y_planet_old))
    
x_asteroid2=solnasteroid2[:,0]
y_asteroid2=solnasteroid2[:,2]
        
k=1.2*initial_x_asteroidref
initial_x_asteroid3=k
initial_y_asteroid3=0

initial_conditions_asteroid3=[initial_x_asteroid3, initial_vx_asteroidref, initial_y_asteroid3, initial_vy_asteroidref]
solnasteroid3=spi.odeint(asteroid,initial_conditions_asteroid3,t2,args=(x_planet_old,y_planet_old))
    
x_asteroid3=solnasteroid3[:,0]
y_asteroid3=solnasteroid3[:,2]

fig = pl.figure()
ax = pl.axes(xlim=(-3e12, 3e12), ylim=(-3e12, 3e12))
...
anim = animation.FuncAnimation(fig, animate, init_func=init,
                               frames=100000000, interval=0.001, blit=True)
